...
export default function NotFound() {
  return (
    <main id="main-content" className="min-h-[100svh] bg-cream-50 dark:bg-neutral-950 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 overflow-x-hidden w-full">
